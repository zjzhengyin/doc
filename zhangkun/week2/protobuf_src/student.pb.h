...
class Student : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_gard() const;
  inline void clear_gard();
  static const int kGardFieldNumber = 3;
  inline float gard() const;
  inline void set_gard(float value);
 ...
 private:
  ...
  inline void set_has_gard();
  inline void clear_has_gard();
...
// optional float gard = 3;
inline bool Student::has_gard() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void Student::set_has_gard() {
  _has_bits_[0] |= 0x00000004u;
}
inline void Student::clear_has_gard() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void Student::clear_gard() {
  gard_ = 0;
  clear_has_gard();
}
inline float Student::gard() const {
  return gard_;
}
inline void Student::set_gard(float value) {
  set_has_gard();
  gard_ = value;
}
